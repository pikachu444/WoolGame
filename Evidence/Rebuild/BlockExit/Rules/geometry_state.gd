...
func run():
 ...
 test_state()
 var resources={}
 for path in ["res://scripts/block_flight.gd","res://scripts/state.gd","res://scripts/board.gd","res://scripts/campaign.gd","res://scripts/game.gd","res://scripts/world.gd","res://scripts/map_theme.gd","res://scripts/background.gd","res://scripts/hud.gd","res://scripts/profile.gd"]:resources[path]=FileAccess.get_sha256(path)
