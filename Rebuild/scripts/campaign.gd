...
const LESSONS=["위쪽부터 차례로 꺼내요","가로 화살표는 옆 출구로 나가요","아래쪽 출구도 함께 살펴봐요","막힌 색의 앞을 먼저 열어요","긴 실을 감는 동안 다음 색을 골라요","다섯 색을 네 칸 선반에 나눠 담아요","안개 밖에서 보이는 색을 먼저 골라요","짧은 실로 자리를 만들고 긴 실을 준비해요","두 용의 색을 번갈아 살펴봐요","출구와 선반, 두 용을 함께 살펴봐요"]
